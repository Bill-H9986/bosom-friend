...
- **AI-assisted edits follow the vibe-coding constraints.** Before writing code, before accepting an AI-produced change, and before declaring work done, follow [vibe-coding-guide](.agents/skills/vibe-coding-guide/SKILL.md) and the full [Vibe-Coding-避坑实战指南.md](Vibe-Coding-避坑实战指南.md): plan before code, small atomic commits, reuse over re-invention, evidence-based acceptance (screenshots/reproducible steps), and honest failure reporting.
