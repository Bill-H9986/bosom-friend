...
export const PLUGIN_DOWNLOAD_LINKS = {
  chrome:
    'https://chromewebstore.google.com/detail/zhiyin-extension/hnmocdhmnfgcjnedmdgfefcobideaeja',
  china: 'https://ai-to-earn.oss-cn-beijing.aliyuncs.com/comment/zhiyin-extension.crx',
  github: 'https://github.com/zhiyin/releases/download/v2.1.0/zhiyin-extension.crx',
} as const
