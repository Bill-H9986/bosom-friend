...
import type { MaterialPagination, PromotionPlan } from '@web/api/materials/material.types'

export type { MaterialPagination, PromotionPlan } from '@web/api/materials/material.types'
