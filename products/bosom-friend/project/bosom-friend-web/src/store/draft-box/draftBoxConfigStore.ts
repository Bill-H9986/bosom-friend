...
import type { MaterialGenerationParams } from '@web/api/materials/material.types'
import type { PlatType } from '@web/app/config/platConfig'
import isEqual from 'lodash/isEqual'
import { stripCaptionPromptSystemRequirement, stripDraftPromptLimits } from '@web/components/draft-box/utils/promptLimits'
