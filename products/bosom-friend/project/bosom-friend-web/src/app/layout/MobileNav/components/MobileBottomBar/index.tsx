...
import { visibleRouterData } from '@web/app/layout/routerData'
import { cn } from '@web/utils/className'

const bottomNavItems = [
  { routerKey: 'header.draftBox', labelKey: 'header.draftBox', testId: 'content' },
  { routerKey: 'xhsData', labelKey: 'xhsData', testId: 'interaction' },
  { routerKey: 'knowledge', labelKey: 'knowledge', testId: 'knowledge' },
] as const
...
export function MobileBottomBar({ currentRoute, hidden }: MobileBottomBarProps) {
  ...
  return (
    <>
      ...
      >
        <div className="grid h-14 grid-cols-3 items-center gap-0.5 px-2 py-2">
