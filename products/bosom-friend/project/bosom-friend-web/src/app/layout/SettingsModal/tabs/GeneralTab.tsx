...
import { getAllLanguageOptions } from '@web/app/i18n/languageConfig'
import { cookieName } from '@web/app/i18n/settings'
import {
  Select,
  SelectContent,
  SelectItem,
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    isActive ? 'text-brand-purple-deep font-medium' : 'text-muted-foreground',
                  )}
                >
                  {t(option.labelKey)}
                </span>
