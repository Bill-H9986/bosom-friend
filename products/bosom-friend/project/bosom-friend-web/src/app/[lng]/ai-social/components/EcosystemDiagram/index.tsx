/**
 * EcosystemDiagram - Bosom Friend 生态系统图
 * 一图解释 Bosom Friend 的核心功能和生态闭环
            ...
            <div className="hidden md:flex items-center justify-center gap-8 lg:gap-12">
              ...
              <div className="relative">
                <div className="relative w-[320px] h-[320px] lg:w-[380px] lg:h-[380px]">
                  {/* 宇宙背景光晕 */}
                  <div className="absolute inset-[-20px] rounded-full bg-gradient-to-r from-pink-500/5 via-purple-500/5 to-violet-500/5 blur-2xl animate-pulse" />
                  ...
                  <div className="absolute inset-0 rounded-full border border-dashed border-blue-300/30 dark:border-blue-400/20 animate-[spin_60s_linear_infinite]">
                    {/* 轨道上的卫星点 */}
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-violet-400/60 shadow-[0_0_8px_2px_rgba(169,137,255,0.45)]" />
                  ...
                  <div className="absolute inset-[72px] lg:inset-20 rounded-full overflow-hidden">
                    {/* 多层渐变光晕 */}
                    <div className="absolute inset-0 rounded-full bg-gradient-to-br from-pink-100 via-purple-50 to-violet-100 dark:from-pink-900/40 dark:via-purple-900/30 dark:to-violet-900/40" />
                    ...
                    {/* 核心光芒 */}
                    <div className="absolute inset-2 rounded-full bg-white/80 dark:bg-background/80 shadow-[inset_0_0_30px_rgba(169,137,255,0.16),0_0_20px_rgba(169,137,255,0.12)]" />
                    {/* 脉动光环 */}
                  ...
                  {/* 星星装饰粒子 */}
                  <div className="absolute top-[10%] left-[15%] w-1 h-1 rounded-full bg-violet-400/80 animate-[twinkle_2s_ease-in-out_infinite]" />
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="flex items-center gap-2 text-muted-foreground text-sm">
                  ...
                  <div className="relative">
                    ...
                    {/* 能量粒子动画 */}
                    <div className="absolute top-1/2 left-0 w-1 h-1 rounded-full bg-violet-400 animate-[energyFlow_1.5s_ease-in-out_infinite]" />
                  </div>
                </div>

                <div className="relative px-5 py-2.5 rounded-full bg-gradient-to-r from-pink-50 to-purple-50 dark:from-pink-900/30 dark:to-purple-900/30 border border-purple-200/50 dark:border-purple-700/30 shadow-md">
                  <span className="text-foreground font-medium text-sm whitespace-nowrap">
                    {t('ecosystem.trade')}
                  </span>
                  {/* 光晕效果 */}
                  <div className="absolute inset-0 rounded-full bg-gradient-to-r from-pink-400/10 to-purple-400/10 animate-pulse" />
                </div>
              ...
              <div>
                <div className="relative w-32 h-32 lg:w-40 lg:h-40">
                  {/* 外层光晕 */}
                  <div className="absolute inset-[-10px] rounded-full bg-gradient-to-br from-violet-500/10 via-pink-500/10 to-rose-400/10 blur-xl animate-pulse" />
                  ...
                  <div className="absolute inset-[-8px] rounded-full border border-dashed border-purple-300/30 dark:border-purple-400/20 animate-[spin_40s_linear_infinite]">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1.5 h-1.5 rounded-full bg-rose-400/70 shadow-[0_0_6px_2px_rgba(255,119,160,0.5)]" />
                  </div>
                  ...
                  <div className="absolute inset-3 rounded-full overflow-hidden">
                    {/* 渐变背景 */}
                    <div className="absolute inset-0 rounded-full bg-gradient-to-br from-violet-100 via-pink-50 to-rose-100 dark:from-violet-900/40 dark:via-pink-900/30 dark:to-rose-900/40" />
                    {/* 光泽效果 */}
            ...
            <div className="md:hidden space-y-6">
              ...
              <div className="flex justify-center">
                <div className="relative w-40 h-40">
                  {/* 光晕 */}
                  <div className="absolute inset-[-10px] rounded-full bg-gradient-to-r from-pink-500/10 via-purple-500/10 to-violet-500/10 blur-xl animate-pulse" />

                  {/* 轨道环 */}
                  <div className="absolute inset-0 rounded-full border border-dashed border-blue-300/30 animate-[spin_40s_linear_infinite]">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1.5 h-1.5 rounded-full bg-violet-400/60 shadow-[0_0_6px_2px_rgba(169,137,255,0.45)]" />
                  </div>
                  ...
                  {/* 星球核心 */}
                  <div className="absolute inset-8 rounded-full bg-gradient-to-br from-pink-50 to-purple-50 dark:from-pink-900/30 dark:to-purple-900/30 border border-purple-200/30 dark:border-purple-700/20 shadow-md">
              ...
              <div className="flex justify-center items-center gap-4">
                ...
                <div className="relative px-4 py-2 rounded-full bg-gradient-to-r from-pink-50 to-purple-50 dark:from-pink-900/30 dark:to-purple-900/30 border border-purple-200/50 dark:border-purple-700/30 shadow-sm">
...
function FunctionNode({ label, angle, radius, isActive, onClick }: FunctionNodeProps) {
  ...
  return (
    <button
      type="button"
      className={cn(
        'absolute cursor-pointer z-20 h-10 px-5 rounded-lg flex items-center shadow-md border transition-all duration-300',
        // 居中定位节点
...
function MobileFunctionNode({
  ...
  return (
    <button
      type="button"
      className={cn(
        'h-10 px-4 rounded-lg shadow-sm border text-center transition-all duration-300 cursor-pointer',
        isActive
