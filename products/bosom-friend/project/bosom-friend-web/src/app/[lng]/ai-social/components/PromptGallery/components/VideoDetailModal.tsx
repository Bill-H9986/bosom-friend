              ...
              {item.materials && item.materials.length > 0 && (
                <div className="mt-4 pt-4 border-t border-border">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="px-2 py-0.5 text-xs rounded-full bg-gradient-to-r from-[#8b7cf6]/10 to-[#a78bfa]/10 text-foreground/70 border border-[#a78bfa]/25">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {item.materials.map((material, idx) => (
                      <div
                        key={idx}
                        className="relative w-16 h-16 rounded-lg overflow-hidden border border-border bg-muted hover:border-[#a78bfa]/45 transition-colors"
                      >
                        <Image src={resolveAsset(material)} alt={`material-${idx + 1}`} fill className="object-cover" sizes="64px" />
                      </div>
                    ))}
                  </div>
