...
import type { ChannelPublishRecordItem, ChannelPublishRecordListVo } from '@web/api/channels/channel.types'
import type { PublishRecordItem } from '@web/api/platforms/publish.types'
import lodash from 'lodash'
import { create } from 'zustand'
import { combine } from 'zustand/middleware'
import { getChannelPublishRecordApi, getChannelPublishRecordsApi } from '@web/api/channels/channel.api'
import { PublishStatus } from '@web/api/platforms/publish.constants'
import { getDays } from '@web/app/[lng]/accounts/components/CalendarTiming/calendarTiming.utils'
