...
import type { VideoGenerationHistoryItem, VideoGenerationTimestamp } from '@web/api/ai/ai.types'
...
import { getVideoGenerations } from '@web/api/ai/ai.api'
import { useTransClient } from '@web/app/i18n/client'
import { getDateLocale } from '@web/app/i18n/languageConfig'
...
import { Empty } from '@web/components/ui/empty'
      ...
      setPreviewItems([
        {
          type: 'video',
          src: videoUrl,
          title: `${String(video.prompt || '').substring(0, 50)}...`,
        },
      ])
      setPreviewIndex(0)
      setPreviewOpen(true)
            ...
            {isLoading && videos.length === 0 ? (
              ...
              <div className="space-y-4">
                {videos.map((video, index) => (
                  <div
                    key={video.task_id || `${video.submit_time}-${index}`}
