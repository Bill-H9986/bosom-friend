...
import type { AssetVo } from '@web/types/agent-asset'
import { Play } from 'lucide-react'
import { memo, useCallback } from 'react'
import { OssImage } from '@web/components/common/OssImage'
import { useVideoThumbnail } from '@web/hooks/useVideoThumbnail'
import { getAssetMediaType, getAssetThumbUrl } from '@web/utils/agent/asset'
import { cardSurface, cardImageZoom } from '@web/utils/card'
import { cn } from '@web/utils/className'
import { formatSeconds } from '@web/utils/format'
...
export const AgentAssetCard = memo(({ asset, previewLabel, onClick }: AgentAssetCardProps) => {
  ...
  return (
    <button
      ...
      className={cn(
        cardSurface,
        'block w-full cursor-pointer bg-muted min-h-[120px] text-left',
      ...
      {hasThumb ? (
        ...
        <div className="relative">
          <OssImage
            ...
            width={400}
            height={300}
            className={`w-full h-auto block ${cardImageZoom}`}
