...
import { MASONRY_BREAKPOINTS } from '@web/components/draft-box/components/masonryBreakpoints'
import { Button } from '@web/components/ui/button'
import { useDocumentTitle } from '@web/hooks'
import { getAssetMediaType } from '@web/utils/agent/asset'
      ...
      <main className="px-4 py-6">
        <div className="w-full mx-auto">
          {isLoading ? (
            ...
            // 空状态
            <div className="flex min-h-[calc(100vh-260px)] flex-col items-center justify-center py-20">
