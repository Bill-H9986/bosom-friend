import type { ImageLoader, ImageLoaderProps, ImageProps, StaticImageData } from '@web/next-shims/image'
import Image from '@web/next-shims/image'
import { getOssThumbnailUrl, getOssUrl } from '@web/utils/oss'
...
export { getImageProps } from '@web/next-shims/image'
