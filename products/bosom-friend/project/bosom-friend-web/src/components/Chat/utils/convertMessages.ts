import type { TaskMessage } from '@web/api/ai/ai.types'
import type { IUploadedMedia } from '@web/components/Chat/MediaUpload'
import type { IDisplayMessage, IMessageStep, IWorkflowStep } from '@web/store/agent'
  ...
  messages.forEach((msg, index) => {
    ...
    if (msg.type === 'user') {
      ...
      if (result.contentToAdd) {
        ...
        lastAssistantMsgIndex = displayMessages.findLastIndex(message => message.role === 'assistant')
      }
