...
export function ChatInput({
  ...
  /** 自动增长上限：large 默认 200px，compact 默认 180px */
  const resolvedMaxHeight = maxHeight ?? (mode === 'large' ? 200 : 180)
  ...
  useEffect(() => {
    ...
    textarea.style.overflowY = nextHeight >= resolvedMaxHeight ? 'auto' : 'hidden'
  }, [value, mode, resolvedMaxHeight])
