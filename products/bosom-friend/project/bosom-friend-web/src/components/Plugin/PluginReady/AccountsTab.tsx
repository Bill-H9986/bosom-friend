...
import type { PlatAccountInfo } from '@web/store/plugin/types/plat.type'
...
import { getXhsLoginStatus, isPluginPlatformAccountReady, usePluginStore } from '@web/store/plugin'
import { PLUGIN_SUPPORTED_PLATFORMS } from '@web/store/plugin/types/baseTypes'
