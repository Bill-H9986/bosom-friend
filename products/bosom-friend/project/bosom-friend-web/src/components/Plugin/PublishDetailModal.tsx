...
import type {
  ...
  PlatformPublishTask,
  PublishTask,
} from '@web/store/plugin/types/baseTypes'
import { CircleOff, ExternalLink, Loader2, Minimize2, Smartphone } from 'lucide-react'
import { useCallback, useEffect, useRef, useState } from 'react'
import { useTranslation } from 'react-i18next'
import { QRCode } from 'react-qrcode-logo'
import { cancelChannelPublishTaskApi } from '@web/api/channels/channel.api'
...
import { useDouyinPublishSession } from '@web/hooks/useDouyinPublishSession'
...
import { openDeepLink } from '@web/utils/appLaunch'
