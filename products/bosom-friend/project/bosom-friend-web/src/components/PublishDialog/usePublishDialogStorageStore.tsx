...
import { isPublishTitleSupported, isSameSocialAccount } from '@web/components/PublishDialog/PublishDialog.util'
import { usePublishDialog } from '@web/components/PublishDialog/usePublishDialog'
import { useAccountStore } from '@web/store/account'
import { isPlatformEnabledSync, isPlatformMetadataReadySync } from '@web/store/platformMetadata'
...
function getMediaUrlExtension(url: string) {
  try {
    const parsedUrl = new URL(getDisplayMediaUrl(url), APP_SITE_URL)
