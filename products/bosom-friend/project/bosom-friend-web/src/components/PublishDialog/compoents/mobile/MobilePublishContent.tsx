...
import { DouyinLaunchModal } from '@web/components/PublishDialog/compoents/DouyinLaunchModal'
import ErrorSummary from '@web/components/PublishDialog/compoents/ErrorSummary'
import PlatParamsSetting from '@web/components/PublishDialog/compoents/PlatParamsSetting'
...
import { usePublishManageUpload } from '@web/components/PublishDialog/compoents/PublishManageUpload/usePublishManageUpload'
import PubParmasTextarea from '@web/components/PublishDialog/compoents/PubParmasTextarea'
import { useAccountClickHandler } from '@web/components/PublishDialog/hooks/useAccountClickHandler'
import { useAutoPublishOnReady } from '@web/components/PublishDialog/hooks/useAutoPublishOnReady'
import { useCloseDialog } from '@web/components/PublishDialog/hooks/useCloseDialog'
import { usePlatformAuth } from '@web/components/PublishDialog/hooks/usePlatformAuth'
import { usePublishActions } from '@web/components/PublishDialog/hooks/usePublishActions'
import usePubParamsVerify from '@web/components/PublishDialog/hooks/usePubParamsVerify'
import { useValidatedPublishTrigger } from '@web/components/PublishDialog/hooks/useValidatedPublishTrigger'
import { getCommonPublishTitleMax } from '@web/components/PublishDialog/PublishDialog.util'
...
import { usePlatformInfoMap } from '@web/hooks/usePlatformMetadata'
