...
import InlinePlatformSelector from '@web/components/draft-box/components/CreateMaterialModal/InlinePlatformSelector'
  ...
  return (
    <>
      <Button
        ...
        className={cn(
          'h-9 rounded-full border border-transparent bg-gradient-back px-3 font-medium text-gradient-foreground shadow-lg shadow-primary/25',
          'cursor-pointer gap-1.5 transition-all duration-200 hover:border-transparent hover:shadow-xl hover:shadow-primary/35 hover:-translate-y-px',
        )}
      >
        {isCreating
