  ...
  return (
    <div className={cn('px-4', compactBottomPadding ? 'pb-7' : 'pb-3')}>
      <div className="flex flex-col gap-2 @min-[640px]:flex-row @min-[640px]:items-center">
        <div className="flex shrink-0 items-center gap-1 text-xs font-normal text-muted-foreground @min-[640px]:w-16">
          <span>{label}</span>
        ...
        <Input
          className="h-6 rounded-none border-x-0 border-t-0 border-b border-dashed border-border/40 bg-transparent px-0 py-0 text-xs leading-none text-muted-foreground shadow-none focus-visible:border-muted-foreground/70 focus-visible:text-foreground focus-visible:ring-0 md:text-xs"
