      ...
      <div className={cn(pillClass, 'gap-0 p-0')}>
        <Popover open={open} onOpenChange={setOpen}>
          ...
          <PopoverContent className="w-64 p-3" side="top" align="start">
            {/* 不兼容警告 banner */}
            {disabledSelectedCount > 0 && (
              <div className="flex items-start gap-1.5 mb-2 p-2 rounded-md bg-warning/10 text-warning-foreground text-xs">
                    ...
                    if (isMobile) {
                      return (
                        <div key={plat} className="col-span-2">
                          {button}
                          <div className="px-2 pb-1 text-[10px] text-warning/80 leading-tight">
