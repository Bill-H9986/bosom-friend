...
const c = await (await fetch(base + '/bosom-friend/api/ai/draft-generation/v2', { method: 'POST', headers: H, body: JSON.stringify({ quantity: 1, groupId: 'g', model: 'm', prompt: '测试' }) })).json();
